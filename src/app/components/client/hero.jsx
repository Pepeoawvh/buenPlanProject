  ...
  return (
    <section id='hero' className='grid w-full justify-items-center'>
      <div className='grid auto-rows-min gap-4 items-center justify-items-center ] p-2 py-6 bg-white'>
        ...
        <button className={`${bebas.className} ${styles.zoomImage} my-2 bg-[#2694e7] shadow-md justify-self-center border-4  border-white py-2 px-3 rounded-full text-2xl pt-3 text-white`}>
          Solicitar Asesoría
        </button>
      </div>
    </section>
