  ...
  useEffect(() => {
    const fetchPost = async () => {
      ...
      try {
        ...
        // Usar 'blogbuenplan' como nombre de colección estándar
        ...
        // Procesar objetos complejos que podrían venir como strings JSON
        ...
        fieldsToProcess.forEach(field => {
          if (postData[field]) {
            try {
              ...
              // Si sigue siendo un string y el campo es relatedTopics, divídelo por comas
              ...
              console.warn(`Error al procesar ${field}:`, err);
